      ...
      <ThemeProvider theme={theme}>
        ...
        >
          ...
          >
            ...
            >
              <Grid item xs={7}>
                <Grid container direction="column">
                  ...
                  <Grid
                    item
                    sx={{ height: "200px", padding: 3, mt: 5 }}
                    className={classes.textBox}
                  >
                    <Typography sx={{ fontSize: 25, fontWeight: "bold" }}>
                      Our Mission
            ...
            <Grid container direction="row" justifyContent="" sx={{ mt: 4 }}>
              <Grid item>
                <ThemeProvider theme={theme2}>
                  <Button variant="contained" fullWidth onClick={getStarted}>
                    Get started{" "}
                    <ArrowForwardIcon sx={{ ml: 1, width: 18, height: 18 }} />
                  </Button>
                </ThemeProvider>
              </Grid>
            </Grid>
