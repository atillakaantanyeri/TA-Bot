...
export default function Lectures() {
  ...
  useEffect(() => {
    axios
      .get(
        "http://localhost:4000/api/lectures/getBySemesterAndDepartmentId?departmentId=" +
  ...
  function addLecture() {
    ...
    } else if (!isLectureExist(values.lecture)) {
      setValues({
        ...values,
        showAddMsg: true,
        addMsg: "" + values.lecture + " already exist in lectures",
      });
    } else {
  ...
  function isLectureExist(selectedLecture) {
    let tempLecture = selectedLecture.split(" - ");
    let status = true;
    myLectures.forEach((lecture) => {
      if (lecture.code === tempLecture[0]) {
        status = false;
      }
    });
    return status;
  ...
  function deleteLecture(index) {
    ...
    setValues({
      ...
      showDeleteMsg: true,
      deletedLecture:
        tempLectures[index].code + " - " + tempLectures[index].name,
    });
          ...
          >
            ...
            {values.isAddLectureHidden && values.isEditLectureHidden ? null : (
              ...
              <>
                ...
                >
                  <Grid item>
                    <Grid container direction="row" justifyContent="" sx={{}}>
                      <Grid
                        item
                        ...
                        sx={{
                          cursor: "pointer",
                          pb: 2,
                          borderBottom: values.isAddLectureHidden
                            ? "1px solid black"
                            : "2px solid black",
                        }}
                      >
                        <Typography
                          sx={{
                            fontSize: 15,
                            fontWeight: values.isAddLectureHidden
                              ? "normal"
                              : 800,
                            textAlign: "center",
                          }}
                      ...
                      <Grid
                        item
                        onClick={() => showHideDeleteLecture()}
                        xs={3}
                        sx={{
                          ml: 5,
                          cursor: "pointer",
                          pb: 2,
                          borderBottom: values.isDeleteLectureHidden
                            ? "1px solid black"
                            : "2px solid black",
                        }}
                      >
                        <Typography
                          sx={{
                            fontSize: 15,
                            fontWeight: values.isDeleteLectureHidden
                              ? "normal"
                              : 800,
                            textAlign: "center",
                          }}
                          ...
                          >
                            <Grid
                              ...
                              sx={{
                                mt: 1,
                                fontWeight: "bold",
                                color: values.addMsg.includes("select")
                                  ? "red"
                                  : "green",
                              }}
                            >
                        ...
                        <Grid item>
                          <Grid container direction="row" sx={{}}>
                            <Grid item xs={12} sx={{ textAlign: "center" }}>
                              You don't have any lectures. Please add new
                              lectures to chat with TA-Bot.
                            </Grid>
                          </Grid>
                        </Grid>
                      ) : null}
            ...
            {!values.isMyLecturesHidden ? (
              ...
              //MY LECTURES
              <>
                <Grid container direction="column" sx={{ mt: 4, pl: 3 }}>
                  <Grid item>
                    <hr />
                  </Grid>
                </Grid>
                ...
                >
                  {!myLectures[0] ? (
                    ...
                    >
                      <Grid item>
                        You don't have any lectures. Please add new lectures to
                        chat with TA-Bot.
                      </Grid>
                    </Grid>
                  ) : (
                  ...
                  {myLectures.map((lecture, index) => (
                    <Grid item xs={5} sx={{ mt: index > 1 ? 4 : null, mb: 10 }}>
                      <Grid
                        item
                        sx={{ p: 3 }}
